...
extension UIAlertController {
    ...
    func addOneTextField(configuration: AlertableTextField.Config?) {
...
final class OneTextFieldViewController: UIViewController {
    ...
    fileprivate lazy var textField: AlertableTextField = AlertableTextField()
    ...
    init(vInset: CGFloat = 12, configuration: AlertableTextField.Config?) {
