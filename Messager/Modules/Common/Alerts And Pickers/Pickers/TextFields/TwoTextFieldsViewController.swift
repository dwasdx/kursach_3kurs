...
extension UIAlertController {
    ...
    func addTwoTextFields(height: CGFloat = 58, hInset: CGFloat = 0, vInset: CGFloat = 0, textFieldOne: AlertableTextField.Config?, textFieldTwo: AlertableTextField.Config?) {
...
final class TwoTextFieldsViewController: UIViewController {
    ...
    fileprivate lazy var textFieldOne: AlertableTextField = AlertableTextField()
    fileprivate lazy var textFieldTwo: AlertableTextField = AlertableTextField()
    
    fileprivate var height: CGFloat
    fileprivate var hInset: CGFloat
    fileprivate var vInset: CGFloat
    
    init(height: CGFloat, hInset: CGFloat, vInset: CGFloat, textFieldOne configurationOneFor: AlertableTextField.Config?, textFieldTwo configurationTwoFor: AlertableTextField.Config?) {
        self.height = height
        self.hInset = hInset
        self.vInset = vInset
