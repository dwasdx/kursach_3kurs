...
open class AlertableTextField: UITextField {
    
    public typealias Config = (AlertableTextField) -> Swift.Void
    ...
    public func action(closure: @escaping Action) {
        if actionEditingChanged == nil {
            addTarget(self, action: #selector(AlertableTextField.textFieldDidChange), for: .editingChanged)
        }
